...
Service = collections.namedtuple(
    "Service", ("name", "debug_port", "grpc_port", "host_override", "cmd", "deps")
)
...
SERVICES = (
    Service(
        ...
        (
            ...
            "remoteva",
            "--config",
            os.path.join(config_dir, "remoteva-a.json"),
            "--addr",
            ":9397",
            "--debug-addr",
            ":8011",
    ...
    Service(
        ...
        (
            ...
            "remoteva",
            "--config",
            os.path.join(config_dir, "remoteva-b.json"),
            "--addr",
            ":9498",
            "--debug-addr",
            ":8012",
    ...
    Service(
        ...
        (
            ...
            "remoteva",
            "--config",
            os.path.join(config_dir, "remoteva-c.json"),
            "--addr",
            ":9499",
            "--debug-addr",
            ":8023",
    ...
    Service(
        ...
        None,
        None,
        ("./bin/aia-test-srv", "--addr", ":4502", "--hierarchy", "test/certs/webpki/"),
        None,
    ),
    Service(
        "ct-test-srv",
    ...
    Service(
        ...
        (
            ...
            "boulder-ca",
            "--config",
            os.path.join(config_dir, "ca.json"),
            "--addr",
            ":9393",
            "--debug-addr",
            ":8001",
        ...
        (
            "boulder-sa-1",
            "boulder-sa-2",
            "boulder-ra-sct-provider-1",
            "boulder-ra-sct-provider-2",
        ),
    ),
    Service(
        "boulder-ca-2",
    ...
    Service(
        ...
        (
            "./bin/pardot-test-srv",
            "--config",
            os.path.join(config_dir, "pardot-test-srv.json"),
        ),
        None,
    ),
    Service(
        ...
        (
            ...
            "email-exporter",
            "--config",
            os.path.join(config_dir, "email-exporter.json"),
            "--addr",
            ":9603",
            "--debug-addr",
            ":8114",
    ...
    Service(
        ...
        None,
        (
            "./bin/zendesk-test-srv",
            "--config",
            os.path.join(config_dir, "zendesk-test-srv.json"),
        ),
        None,
    ),
    Service(
        ...
        (
            ...
            "sfe",
            "--config",
            os.path.join(config_dir, "sfe.json"),
            "--debug-addr",
            ":8015",
        ),
        (
...
def start(coverage_dir=None):
    ...
    try:
        ...
        print(
            "Error querying DNS. Is consul running? `docker compose ps bconsul`. %s"
            % (e)
        )
        return False
...
def startChallSrv():
    ...
    challSrvCmd = [
        ...
        ":8343,:8443",
        "--doh-cert",
        "test/certs/ipki/10.77.77.77/cert.pem",
        "--doh-cert-key",
        "test/certs/ipki/10.77.77.77/key.pem",
        "--management",
        ":8055",
        "--http01",
        "64.112.117.122:80",
